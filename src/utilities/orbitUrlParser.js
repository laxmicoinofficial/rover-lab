...
// routeTable is derived from Orbit init_web.go. `routeTable` is intended to
// look similar to Orbit's code for routing requests.
...
let routeTable = {
  ...
  // dakibot
  // r.Post("/dakibot", &DakibotAction{})
  // r.Get("/dakibot", &DakibotAction{})
...
function orbitUrlParser(inputUrl) {
