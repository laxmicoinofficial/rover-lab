...
//   {
//     name: 'createAccount', // Corresponds to the operation key in rover-js-sdk.Operation
...
export const operationsMap = [
  {
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#create-account',
  },
  {
    name: 'payment',
    label: 'Payment',
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#payment',
  },
  {
    name: 'pathPayment',
    label: 'Path Payment',
  ...
  },
  {
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#manage-offer',
  },
  {
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#create-passive-offer',
  },
  {
    name: 'setOptions',
    label: 'Set Options',
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#set-options',
  },
  {
    name: 'changeTrust',
    label: 'Change Trust',
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#change-trust',
  },
  {
    name: 'allowTrust',
    label: 'Allow Trust',
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#allow-trust',
  },
  {
    name: 'accountMerge',
    label: 'Account Merge',
  ...
  },
  {
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#inflation',
  },
  {
    name: 'manageData',
    label: 'Manage Data',
    ...
    docsUrl: 'https://www.rover.network/developers/guides/concepts/list-of-operations.html#manage-data',
  },
]
