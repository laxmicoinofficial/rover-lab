...
import {xdr} from 'rover-network-sdk';
    ...
    <div className="XdrViewer__setup so-back">
      <div className="so-chunk">
        <div className="pageIntro">
          <p><a href="https://www.rover.network/developers/orbit/reference/xdr.html">External Data Representation (XDR)</a> is a standardized protocol that the Rover network uses to encode data.</p>
          <p>The XDR Viewer is a tool that displays contents of a Rover XDR blob in a human readable format.</p>
        </div>
