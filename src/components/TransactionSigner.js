...
import {Transaction, Keypair, Network} from 'rover-network-sdk';
    ...
    if (validateTxXdr(xdr).result !== 'success') {
      ...
      if (!_.isUndefined(result.xdr)) {
        ...
        submitInstructions = <p className="TxSignerResult__instructions">
          Now that this transaction is signed, you can submit it to the network. Orbit provides an endpoint called Post Transaction that will relay your transaction to the network and inform you of the result.
        </p>
      }
        ...
        <div className="so-back">
          ...
          <div className="so-chunk">
            <div className="TxSignerKeys TransactionSigner__keys">
              <p className="TxSignerKeys__title">Signatures <HelpMark href="https://www.rover.network/developers/guides/concepts/multi-sig.html" /></p>
      ...
      <div className="so-back">
        <div className="so-chunk">
          <div className="pageIntro">
            <p>
              The transaction signer lets you add signatures to a Rover transaction. Signatures are used in the network to prove that the account is authorized to perform the operations in the transaction.
            </p>
            <p>
            ...
            <p><a href="https://www.rover.network/developers/guides/concepts/multi-sig.html" target="_blank">Read more about signatures on the developer's site.</a></p>
          </div>
        </div>
      </div>
      {content}
