...
import {StrKey} from 'rover-network-sdk';
...
export default function TxBuilderAttributes(props) {
  ...
  return <div className="TransactionAttributes">
    <div className="TransactionOp__config TransactionOpConfig optionsTable">
      <OptionsTablePair label={<span>Source Account <HelpMark href="https://www.rover.network/developers/guides/concepts/accounts.html" /></span>}>
        <PubKeyPicker
      ...
      <OptionsTablePair label={<span>Transaction Sequence Number <HelpMark href="https://www.rover.network/developers/guides/concepts/transactions.html#sequence-number" /></span>}>
        <SequencePicker
      ...
      <OptionsTablePair optional={true} label={<span>Base Fee <HelpMark href="https://www.rover.network/developers/guides/concepts/transactions.html#fee" /></span>}>
        <StroopsPicker
          value={attributes['fee']}
          onUpdate={(value) => {onUpdate('fee', value)}}
          />
        <p className="optionsTable__pair__content__note">The <a href="https://www.rover.network/developers/guides/concepts/fees.html">network base fee</a> is currently set to 100 mint (0.00001 laxmicoins). Transaction fee is equal to base fee times number of operations in this transaction.</p>
      </OptionsTablePair>
      <OptionsTablePair optional={true} label={<span>Memo <HelpMark href="https://www.rover.network/developers/guides/concepts/transactions.html#memo" /></span>}>
        <MemoPicker
          value={{
      ...
      <OptionsTablePair optional={true} label={<span>Time Bounds <HelpMark href="https://www.rover.network/developers/guides/concepts/transactions.html#time-bounds" /></span>}>
        <TimeBoundsPicker
          value={{
